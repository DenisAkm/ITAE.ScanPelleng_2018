...
namespace Integral
{
    public class IncArrow : Renderable
    {
        Effect effect;
        ...
        public IncArrow(int size, double theta, double phi, double polariz)
        {
            try
            {
            ...
            for (int i = 1; i <= 360 / increas; i++)
            {
                ...
                indices.WriteRange(new short[] { (short)(offset + 4), (short)(offset + 5), (short)(offset + 6) });
                indices.WriteRange(new short[] { (short)(offset + 6), (short)(offset + 5), (short)(offset + 4) });
            ...
            for (int i = 1; i <= 360 / increas; i++)
            {
                ...
                short offset = (short)(7 * (i - 1) + count+12);
                indices.WriteRange(new short[] { (short)(offset + 0), (short)(offset + 1), (short)(offset + 2) });
                indices.WriteRange(new short[] { (short)(offset + 2), (short)(offset + 1), (short)(offset + 3) });
